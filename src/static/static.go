...
var SQLFiles = []string{
	// tables
	"sql/tables/TIMELINE_TRIVIA_TIMELINE.sql",
	"sql/tables/TIMELINE_TRIVIA_ERA.sql",
	"sql/tables/TIMELINE_TRIVIA_DECK_TIMELINE.sql",
	...
	"sql/migrations/MIG_TIMELINE_TRIVIA_GAME_ADD_TIMELINE_ID.sql",
	"sql/migrations/MIG_TIMELINE_TRIVIA_GAME_ADD_CURRENT_TURN_STARTED_ON_DATE.sql",
	"sql/migrations/MIG_TIMELINE_TRIVIA_LOG_WIN_ADD_TIMELINE_ID.sql",
	"sql/migrations/MIG_TIMELINE_TRIVIA_CATEGORY_ADD_TIMELINE_ID.sql",
	"sql/migrations/MIG_TIMELINE_TRIVIA_CATEGORY_DROP_NAME_UNIQUE.sql",
	"sql/migrations/MIG_TIMELINE_TRIVIA_CATEGORY_ADD_TIMELINE_NAME_UNIQUE.sql",
